...
//        }
            ...
            case 2:
                ...
                switch (this.op) {
                    ...
                    case "NOT":
                        return not(tmp);
                    default:
                        throw new GrammarException("Unexpected unary operation '" + this.op + "' !");
                }
            case 3:
                ...
                switch (this.op) {
                    ...
                    default:
                        throw new GrammarException("Unexpected binary operation '" + this.op + "' !");
                }
            case 4:
                return new Pair<>(this.symbolORValue, this.valueColumnType);
            default:
                throw new GrammarException("Unknown Expression ColumnType!");
        }
    }
    ...
    public Pair<Object, ColumnType> getDirectValue() {
        ...
        throw new GrammarException("Can't get value directly!");
    }
    ...
    public String getSymbol() {
        if (TypeNum != 1) {
            throw new GrammarException("Not a symbol expression!");
        }
                ...
                if (this.symbolORValue.indexOf(".") == -1) {
                    ...
                    for (Table table : tables) {
                        if (table.getColNames().indexOf(this.symbolORValue) != -1 &&
                            ...
                            if (tableName != null)
                                throw new GrammarException("Column name '" + this.symbolORValue +"' occurs in Table '" +
    ...
    public static Pair<Object, ColumnType> neg(Pair<Object, ColumnType> p) {
        switch (p.getValue()) {
            ...
            default:
                throw new GrammarException("Unsupported NEG operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> non(Pair<Object, ColumnType> p) {
        switch (p.getValue()) {
            ...
            case LONG:
                return new Pair<>(~(long)p.getKey(), p.getValue());
            default:
                throw new GrammarException("Unsupported NON operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> not(Pair<Object, ColumnType> p) {
        switch (p.getValue()) {
            ...
            default:
                throw new GrammarException("Unsupported NOT operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> plus(Object o1, Object o2, ColumnType finalColumnType) {
        switch (finalColumnType) {
            ...
            default:
                throw new GrammarException("Unsupported PLUS operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> minus(Object o1, Object o2, ColumnType finalColumnType) {
        switch (finalColumnType) {
            ...
            case DOUBLE:
                return new Pair<>((double)o1-(double)o2, finalColumnType);
            default:
                throw new GrammarException("Unsupported MINUS operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> multiply(Object o1, Object o2, ColumnType finalColumnType) {
        switch (finalColumnType) {
            ...
            case DOUBLE:
                return new Pair<>((double)o1*(double)o2, finalColumnType);
            default:
                throw new GrammarException("Unsupported MULTIPLY operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> divide(Object o1, Object o2, ColumnType finalColumnType) {
        switch (finalColumnType) {
            ...
            case DOUBLE:
                return new Pair<>((double)o1/(double)o2, finalColumnType);
            default:
                throw new GrammarException("Unsupported DIVIDE operation!");
        }
    }
    ...
    public static Pair<Object, ColumnType> mod(Object o1, Object o2, ColumnType finalColumnType) {
        switch (finalColumnType) {
            ...
            case DOUBLE:
                return new Pair<>((double)o1%(double)o2, finalColumnType);
            default:
                throw new GrammarException("Unsupported MOD operation!");
        }
    }
}
